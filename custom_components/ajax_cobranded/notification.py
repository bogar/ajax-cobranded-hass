...
class AjaxNotificationListener:
    ...
    async def async_start(self) -> None:
        ...
        try:
            ...
            _LOGGER.warning("firebase_messaging not installed, push notifications disabled")
            return
        ...
        fcm_token = fcm_data.get("token") if isinstance(fcm_data, dict) else None
        if fcm_token:
        ...
        try:
            ...
            if hasattr(start_result, "__await__"):
                await start_result
            _LOGGER.debug("FCM push client started")
        except Exception:
    ...
    async def _register_push_token(self, fcm_token: str) -> None:
        ...
        try:
            ...
            if response.HasField("success"):
                ...
                _LOGGER.warning("Failed to register push token with Ajax servers")
        except Exception:
